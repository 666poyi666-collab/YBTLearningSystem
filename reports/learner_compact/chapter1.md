...
| A1 | 类型Ⅰ 线性运算 | 强化训练 | 图形已核验 |
| A2 | 类型Ⅰ 线性运算 | 强化训练 | 文本可用 |
| A3 | 类型Ⅰ 线性运算 | 强化训练 | 图形已核验 |
...
| 项目 | 所属知识/类型 | 教材角色 | 内容状态 |
|---|---|---|---|
| 例12 | 类型Ⅲ 证明共面 | 类型题 | 文本可用 |
| 变式 | 类型Ⅲ 证明共面 | 直属变式 | 图形已核验 |
| B9 | 类型Ⅲ 证明共面 | 强化训练 | 图形已核验 |
...
| B4 | 数量积、夹角与投影向量 | 强化训练 | 图形已核验 |
| B5 | 数量积、夹角与投影向量 | 强化训练 | 图形已核验 |
...
| 例16 | 类型Ⅵ 求角 | 类型题 | 文本可用 |
| 变式1 | 类型Ⅴ 求长度、距离、类型Ⅵ 求角 | 直属变式 | 文本可用 |
| 变式2 | 类型Ⅴ 求长度、距离、类型Ⅵ 求角 | 直属变式 | 图形已核验 |
| 变式1 | 类型Ⅴ 求长度、距离、类型Ⅵ 求角 | 直属变式 | 图形已核验 |
| 变式2 | 类型Ⅴ 求长度、距离、类型Ⅵ 求角 | 直属变式 | 文本可用 |
| B12 | 类型Ⅴ 求长度、距离、类型Ⅵ 求角 | 强化训练 | 图形已核验 |
...
| 项目 | 所属知识/类型 | 教材角色 | 内容状态 |
|---|---|---|---|
| B6 | 数量积、夹角与投影向量 | 强化训练 | 图形已核验 |
| B7 | 数量积、夹角与投影向量 | 强化训练 | 图形已核验 |
...
| 项目 | 所属知识/类型 | 教材角色 | 内容状态 |
|---|---|---|---|
| B8 | 共线向量与共面向量、数量积、夹角与投影向量 | 强化训练 | 文本可用 |
| C13 | 共线向量与共面向量、数量积、夹角与投影向量 | 强化训练 | 文本可用 |
...
| 项目 | 所属知识/类型 | 教材角色 | 内容状态 |
|---|---|---|---|
| C14 | 共线向量与共面向量、数量积、夹角与投影向量 | 强化训练 | 图形已核验 |
...
| B5 | 类型Ⅰ 基底表示 | 强化训练 | 图形已核验 |
| B9 | 类型Ⅰ 基底表示 | 强化训练 | 图形已核验 |
...
| B7 | 类型Ⅲ 数量积坐标表示 | 强化训练 | 文本可用 |
| B10 | 类型Ⅲ 数量积坐标表示 | 强化训练 | 文本可用 |
...
| B12 | 类型Ⅳ 平行垂直 | 强化训练 | 文本可用 |
| B13 | 类型Ⅳ 平行垂直 | 强化训练 | 图形已核验 |
...
| B6 | 类型Ⅴ 夹角与模 | 强化训练 | 文本可用 |
| B11 | 类型Ⅴ 夹角与模 | 强化训练 | 文本可用 |
...
| B4 | 类型Ⅰ 研究平行关系、类型Ⅱ 研究垂直关系 | 强化训练 | 图形已核验 |
...
| 变式1 | 类型Ⅲ 求空间角 | 直属变式 | 图形已核验 |
| 变式2 | 类型Ⅲ 求空间角 | 直属变式 | 文本可用 |
| A1 | 类型Ⅲ 求空间角 | 强化训练 | 文本可用 |
| B3 | 类型Ⅲ 求空间角 | 强化训练 | 文本可用 |
| B6 | 类型Ⅲ 求空间角 | 强化训练 | 图形已核验 |
| B7 | 类型Ⅲ 求空间角 | 强化训练 | 图形已核验 |
...
| B8 | 类型Ⅳ 求距离 | 强化训练 | 图形已核验 |
| C9 | 类型Ⅳ 求距离 | 强化训练 | 文本可用 |
...
| 变式 | 类型Ⅰ 线上动点 | 直属变式 | 文本可用 |
| B1 | 类型Ⅰ 线上动点 | 强化训练 | 图形已核验 |
