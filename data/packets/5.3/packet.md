...
- A1 / `Q-c7221a2f8c6e43f5` / PDF页 36 / VISION_VERIFIED / 1. (2025·广东模拟) 若 \(f'(x)\) 为函数 \(f(x)\) 的导函数， \(f'(x)\) 的图象大致如图所示，则下列关于 \(f(x)\) 的结论正确的是（） A. \(f(0) > f(3)\) B. \(f(3) = f(-1)\) C. \(f(x)\) 在 \((-\infty, 1)\) 上单调递减 D. \(f(x)\) 在
- A2 / `Q-56cca61040bece6d` / PDF页 36 / VISION_VERIFIED / 2.（2025·上海期末） 设 \(f'(x)\) 是函数 \(f(x)\) 的导函数， \(y = f'(x)\) 的图象如图所示，则 \(y = f(x)\) 的图象可能是（） A B
- A3 / `Q-3e6467b021790a50` / PDF页 37 / READY_TEXT_ONLY / 3.（2025·海南模拟） 已知函数 \(f(x)=x^{2}-2x+\ln x\) （1）求 \(f(x)\) 的导函数； （2）求 \(f(x)\) 的单调区间.
- B4 / `Q-6dcd49b4bbe1ba67` / PDF页 37 / VISION_VERIFIED / 4.（2025 · 江西期末） 若 \(f(x)\) 是定义在区间 \((-3,2)\) 上的函数，其图象如图所示，设 \(f(x)\) 的导函数为 \(f'(x)\)，则 \(f(x)f'(x)>0\) 的解集为（） A. \((-2,-1)\cup(1,2)\) B. \((-2,-1)\cup(0,1)\) C. \((-3,-2)\cup(0,1)\
