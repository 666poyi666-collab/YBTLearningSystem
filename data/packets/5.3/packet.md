...
- A1 / `Q-c7221a2f8c6e43f5` / PDF页 36 / NEEDS_VISION_SIDECAR / 1. (2025·广东模拟) 若 \(f'(x)\) 为函数 \(f(x)\) 的导函数， \(f'(x)\) 的图象大致如图所示，则下列关于 \(f(x)\) 的结论正确的是（） A. \(f(0) > f(3)\) B. \(f(3) = f(-1)\) C. \(f(x)\) 在 \((-\infty, 1)\) 上单调递减 D. \(f(x)\) 在
- A2 / `Q-56cca61040bece6d` / PDF页 36 / NEEDS_VISION_SIDECAR / 2.（2025·上海期末） 设 \(f'(x)\) 是函数 \(f(x)\) 的导函数， \(y = f'(x)\) 的图象如图所示，则 \(y = f(x)\) 的图象可能是（） A B
- A3 / `Q-3e6467b021790a50` / PDF页 37 / READY_TEXT_ONLY / 3.（2025·海南模拟） 已知函数 \(f(x)=x^{2}-2x+\ln x\) （1）求 \(f(x)\) 的导函数； （2）求 \(f(x)\) 的单调区间.
- B4 / `Q-6dcd49b4bbe1ba67` / PDF页 37 / NEEDS_VISION_SIDECAR / 4.（2025 · 江西期末） 若 \(f(x)\) 是定义在区间 \((-3,2)\) 上的函数，其图象如图所示，设 \(f(x)\) 的导函数为 \(f'(x)\)，则 \(f(x)f'(x)>0\) 的解集为（） A. \((-2,-1)\cup(1,2)\) B. \((-2,-1)\cup(0,1)\) C. \((-3,-2)\cup(0,1)\
...
- B12 / `Q-3f3a808beb8fa9ca` / PDF页 39 / READY_TEXT_ONLY / ### 12 \. (2025 · 全国模拟) 讨论函数 \(f(x)=(a-1)\ln x+ax^{2}+1\) 的单调性.
- B13 / `Q-48626324a93ddb74` / PDF页 40 / READY_TEXT_ONLY / 13\. （2025 · 贵州六盘水期末） 设函数 \(f(x)=\left(x-\frac{1}{x}\right)\ln x\). （1）求 \(f(x)\) 的定义域，并证明： \(f\left(\frac{1}{x}\right)=f(x)\); （2）讨论 \(f(x)\) 的单调性，并比较 \(f\left(\frac{2}{3}\right)\
- B14 / `Q-f13f64f24305dc86` / PDF页 40 / READY_TEXT_ONLY / 14.（2025·四川达州期末） 已知函数 \(f(x)=2x^{3}-3(a+3)x^{2}+18ax+6\). （1）若 a=0，求曲线 \(y=f(x)\) 在点 \((1,f(1))\) 处的切线方程； （2）讨论函数 \(f(x)\) 的单调性.
- B15 / `Q-f892a1b507e632c0` / PDF页 40 / READY_TEXT_ONLY / ### 15. （2025 · 辽宁模拟（节选）） 已知函数 \(f(x)=\frac{1}{2}ax^2-(2+a)x+2\ln x\) ( \(a\in\mathbb{R}\))，讨论函数 \(f(x)\) 的单调性.
- B16 / `Q-6371c17e1934c920` / PDF页 40 / READY_TEXT_ONLY / ### 16. （2025·福建漳州模拟（节选）） 已知函数 \(f(x) = 2\mathrm{e}^x - ax\) ( \(a \in \mathbf{R}\))，若 \(f(x)\) 有 2 个零点，求 \(a\) 的取值范围.
...
- Q-56cca61040bece6d:NEEDS_VISION_SIDECAR
- Q-6dcd49b4bbe1ba67:NEEDS_VISION_SIDECAR
- Q-c7221a2f8c6e43f5:NEEDS_VISION_SIDECAR
