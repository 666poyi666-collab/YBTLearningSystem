...
- 前置方法必须已通过：`direction_normal, line_plane_angle, distance, moving_point`
...
如图，在棱长为 4 的正方体 \(ABCD-A_1B_1C_1D_1\) 中，点 \(E\)，\(F\) 分别在棱 \(AA_1\) 和 \(AB\) 上，且 \(C_1E\perp EF\)，则 \(AF\) 的最大值为（ ）
...
- 本循环没有新增视频，复用已通过的前置方法。
- 前置方法必须已通过：`direction_normal, parallel_perpendicular, line_plane_angle, plane_equation_upper`
...
- 本循环没有新增视频，复用已通过的前置方法。
- 前置方法必须已通过：`direction_normal, parallel_perpendicular, line_line_angle, line_plane_angle, plane_plane_angle, distance, moving_point`
...
- 本循环没有新增视频，复用已通过的前置方法。
- 前置方法必须已通过：`direction_normal, parallel_perpendicular, line_line_angle, plane_plane_angle, moving_point`
...
- 本循环没有新增视频，复用已通过的前置方法。
- 前置方法必须已通过：`direction_normal, plane_equation_upper, distance, moving_point`
...
> 本批配套题承接：类型Ⅲ 立体几何综合题, 外接球, 空间动点距离, 线面平行垂直, 存在性双参数化, 点面距离, 面面垂直
...
- 本循环没有新增视频，复用已通过的前置方法。
- 前置方法必须已通过：`direction_normal, parallel_perpendicular, line_plane_angle, plane_plane_angle, moving_point`
...
> 本批配套题承接：类型Ⅳ 动态二面角三角方法, 类型Ⅲ 立体几何综合题, 补形与立体几何综合, 线面平行与线面角
