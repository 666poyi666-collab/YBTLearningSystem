...
当前待发布内容计划为选择性必修 1 第一至第五章共 38 节、1,209 个教材项目、5,191 条唯一项目-课程链接和 50 条当前原书答案。课程目录保留 170 门与 19,234 个转写片段；所有章节课程均已落到明确循环，路线映射不等于真人听完或掌握。R2 保存节次题包、课程转写包和题图包；生产版本号以最近一次远端导入回执为准。
