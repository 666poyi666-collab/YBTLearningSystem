...
当前生产内容版本为 `v1-5702925358148534`：选择性必修 1 第一至第五章共 38 节、1,209 个教材项目、5,018 条唯一项目-课程链接和 50 条当前原书答案。课程目录保留 170 门与 19,234 个转写片段；未精确绑定教材项目的课程仍可用于讲义检索，但不冒充覆盖。R2 保存节次题包、课程转写包和题图包。
